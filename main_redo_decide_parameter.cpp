...
//	for (int running_time = 0; running_time < 1; running_time++) {
		...
		ofstream pFile;
		pFile.open(
				"/export/qhome/zyu/intersect/zhenglin/data/src/parameter_decide_redo_experiments_s1_2_bucket.txt",
				ios::app);
		...
		int product_of_bucket_s1 = 1048576;
		int s1 = 2, depth = 1;
		int buckets = product_of_bucket_s1/s1;
		...
		pFile << "Divided by region number" << endl;
