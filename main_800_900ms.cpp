...
int main(int argc, char** argv) {
         ofstream pFile;
         pFile.open("/export/qhome/zyu/intersect/zhenglin/data/src/results_800_900ms_anomaly.txt",  ios::app);
        ...
        for (int running_time =0; running_time < 10; running_time++)
        {
                ...
                if (argc > 1)
                       ...
                       string sample_filename =
                                       "/export/qhome/zyu/intersect/zhenglin/fferent_800_900_ms_range_with_big_changes_dates_Tue_Dec.txt";
