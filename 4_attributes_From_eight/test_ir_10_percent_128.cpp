...
int main(int argc, char** argv) {
	...
	for (int running_time = 0; running_time < 1; running_time++) {
		...
		ofstream pFile;
		pFile.open(
				"/export/qhome/zyu/intersect/zhenglin/data/src/Four_8_experiments/ratio_ten_percent_results_128.txt.txt",
				ios::app);
		...
		for (int reg = 0; reg < num_regions; ++reg) {
			...
			string
					sample_filename =
							"/export/qhome/zyu/intersect/zhenglin/data/src/Four_8_experiments/test_i_R_ten_percent.txt";
			string line;
