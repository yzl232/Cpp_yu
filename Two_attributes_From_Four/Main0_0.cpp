...
int main (int argc, char** argv)
{
  ...
  for(int reg = 0; reg < 1; ++reg)
  {
    ...
    //string sample_filename = "/export/qhome/zyu/intersect/zhenglin/bigger_than_10_percent.txt";
    ...
    long double sumRelErrorF0 = 0.0, sumRelErrorF1 = 0.0, sumRelErrorAvg = 0.0;
    for (int i = 0; i < numPairs; ++i)
    {
    ...
    for (int i = 0; i < numPairs; ++i)
      cout << count1[i] << "/" << count2[i] << "/" << countBoth[i] << "\t";
    cout << endl;

    cout << "Average Relative Error F0 : " << sumRelErrorF0/numPairs << endl;
    cout << "Average Relative Error F1 : " << sumRelErrorF1/numPairs << endl;
    cout << "Average Relative Error Avg : " << sumRelErrorAvg/numPairs << endl;
  ...
  cout << rel_err_F0/num_regions << "\t" << rel_err_F1/num_regions << "\t" << rel_err_Avg/num_regions << endl;
