...
int main(int argc, char** argv) {
         ofstream pFile;
         pFile.open("/export/qhome/zyu/intersect/zhenglin/data/src/bucket_131072_results_2000ms_anomaly.txt",  ios::app);
...
pFile.open("/export/qhome/zyu/intersect/zhenglin/data/src/bucket_131072_results_2000ms_anomaly.txt",  ios::app);
        ...
        for (int running_time =0; running_time < 10; running_time++)
        {
                ...
                int buckets = 131072, depth = 1, s1 = 1;
                ...
                if (argc > 1)
                       ...
                       pFile << "buckets = " << buckets << ", s1 = " << s1 << ", depth = " << depth
                                       << endl;
                       ...
                       for (int i = 0; i < numPairs; ++i) {
                                      pFile << " pair1 i=  " << i << "  " << pair1[i] << ", " << " pair2 i=  "
                                                      << i << "  " << pair2[i] << endl;
                              }
 ...
 vector<long long> realF0(numPairs, 0);
        ...
        for (day = 1; day <= 5; day++) {
                        ...
                        epoch.tm_min = 0;
                                                ...
                                                igzstream in(filename.c_str());
                                                                      ...
                                                                      while (getline(in, line)) {
                                                                              ...
                                                                              //pFile << count << " " << v_F0 << ", " << value << "  " << v_F1 << endl;                                //if (value < 0) { pFile << tokens[21].c_str() << "|" << tokens[22].c_str() << endl; exit(1); }
                ...
                for (int i = 0; i < numPairs; ++i) {
                                       ...
                                       pFile << "processing" << endl;
                                       pFile << "abF0 " << abF0 << " " << "aF0 " << aF0 << " " << "bF0 "
                                                       << bF0 << endl;
                                       ...
                                       pFile << "abF1 " << abF1 << " " << "aF1 " << aF1 << " " << "bF1 "
                                                       << bF1 << endl;
                                       long double estF1 = compute_intersect(abF1, aF1, bF1);

                                       pFile << "pair1[i] " << pair1[i] << "|" << "pair2[i] " << pair2[i]
                                                       << endl;
                                       pFile << "realF0[i] " << realF0[i] << " " << "realF1 " << realF1[i]
                                                       << endl;
                                       ...
                                       esti_data[i][day - 1] = estF1 / estF0;
                                                              ...
                                                              pFile << "Hello! Something is wrong!" << endl;
                                                              ...
                                                              /*
                                                               ...
                                                               pFile << "intersection ratio: " << ir << "\t" << "errors F0: " << fabs(realF0[i] - estF0)/realF0[i] << "\t" << "errors F1 " << fabs(realF1[i] - estF1)/realF1[i] << "\t" << "errors F2 " << fabs(realAvg - estF1/estF0)/realAvg << endl;
                                                               */
                                                              ...
                                                              AMS_Destroy(sketchSumF0);
                                                                      ...
                                                                      for (int i = 0; i < numPairs; i++){
                                                                              pFile << max_temp[i]<<"  " << min_temp[i] << endl;
